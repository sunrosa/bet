...
//!
//! Regardless, if this spamming remains a problem, minimum bets could be enforced. 3 other options would be to scale minimum wagers with the number of bets a person has currently active, or the scale minimum wagers with the person's balance, or both at once, or to hard-cap maximum active bets (that sucks though).
